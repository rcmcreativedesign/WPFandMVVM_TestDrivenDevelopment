...
namespace FriendStorage.UITests.ViewModel
{
  public class NavigationViewModelTests
  {
    ...
    public NavigationViewModelTests()
    {
      ...
      eventAggregatorMock.Setup(ea => ea.GetEvent<FriendSavedEvent>()).Returns(_friendSavedEvent);
      eventAggregatorMock.Setup(ea => ea.GetEvent<FriendDeletedEvent>()).Returns(_friendDeletedEvent);
    ...
    public void ShouldUpdateNavigationItemWhenFriendIsSaved()
    {
      ...
      _friendSavedEvent.Publish(new Friend { Id = friendId, FirstName = "Anna", LastName = "Huber" });
